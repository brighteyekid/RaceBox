#!/usr/bin/env python3
"""
F1 2020 UDP Telemetry Simulator - Continuous Mode
Sends simulated F1 2020 car telemetry packets to ESP32 continuously.

Usage:
    python sim_send_f1_continuous.py [ESP8266_IP]
...
def main():
    ...
    print(f"F1 2020 UDP Telemetry Simulator - CONTINUOUS MODE")
    print(f"Target ESP8266: {esp8266_ip}:{F1_UDP_PORT}")
    print(f"Sending at 20 Hz (every 50ms)")
        ...
        while True:
            ...
            try:
                ...
                if current_time - last_print_time >= 2.0:
                    print(f"Frame {frame_id:6d}: Speed={speed:6.1f} km/h, Gear={gear}, RPM={rpm:4d} | Packets sent: {packets_sent}")
